    ...
    <div>
      ...
      <div className="mt-2">
        <p style={{ color: "blue", fontWeight: "bold" }}>
          1st Sampling Count: {consumer?.SAMPLINGSTICK_visit_1}{" "}
        </p>
        <p style={{ color: "blue", fontWeight: "bold" }}>
          2nd PACKETSALES10S Count: {consumer?.PACKETSALES10S_visit_2}{" "}
        </p>
        <p style={{ color: "blue", fontWeight: "bold" }}>
          2nd PACKETSALES20S Count: {consumer?.PACKETSALES20S_visit_2}
        </p>
      </div>
    </div>
  );
